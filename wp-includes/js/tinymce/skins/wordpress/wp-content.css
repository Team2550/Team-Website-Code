...
.mce-object-style {
	background-image: url(/wp-includes/js/tinymce/skins/wordpress/images/style.svg);
}

.mce-object-script {
	background-image: url(/wp-includes/js/tinymce/skins/wordpress/images/script.svg);
}
